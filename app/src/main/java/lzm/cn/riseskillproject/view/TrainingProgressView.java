...
public class TrainingProgressView extends View {
    ...
    public TrainingProgressView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TrainingProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
